02251C: 49F9 0002 2B9E             lea     $22b9e.l, A4     *第三关
022522: 7000                       moveq   #$0, D0
022524: 102E 006C                  move.b  ($6c,A6), D0
022528: E948                       lsl.w   #4, D0
02252A: D8C0                       adda.w  D0, A4
02252C: 2D4C 0056                  move.l  A4, ($56,A6)
022530: 4E71                       nop
022532: 3D6C 0000 004C             move.w  ($0,A4), ($4c,A6)
022538: 3D6C 0002 004E             move.w  ($2,A4), ($4e,A6)
02253E: 3D6C 0004 0050             move.w  ($4,A4), ($50,A6)
022544: 3D6C 0006 0052             move.w  ($6,A4), ($52,A6)
02254A: 3D6C 0008 0054             move.w  ($8,A4), ($54,A6)
022550: 1D6C 000A 004A             move.b  ($a,A4), ($4a,A6)
022556: 1D6C 000B 0005             move.b  ($b,A4), ($5,A6)
02255C: 426E 0006                  clr.w   ($6,A6)
022560: 1D6C 000C 004B             move.b  ($c,A4), ($4b,A6)
022566: 1D6C 000D 0070             move.b  ($d,A4), ($70,A6)
02256C: 1D6C 000F 0079             move.b  ($f,A4), ($79,A6)
022572: 3D6C 0000 005A             move.w  ($0,A4), ($5a,A6)
022578: 1D6C 000E 007B             move.b  ($e,A4), ($7b,A6)
02257E: 3D6E 000C 005C             move.w  ($c,A6), ($5c,A6)
022584: 522E 006C                  addq.b  #1, ($6c,A6)
022588: 4E75                       rts
02258A: 610A                       bsr     $22596
02258C: 6100 014E                  bsr     $226dc
022590: 4EF9 0002 126E             jmp     $2126e.l
022596: 6100 0128                  bsr     $226c0
02259A: 3D6E 0008 0014             move.w  ($8,A6), ($14,A6)
0225A0: 302E 0060                  move.w  ($60,A6), D0
0225A4: 906E 0008                  sub.w   ($8,A6), D0
0225A8: 0C40 0040                  cmpi.w  #$40, D0
0225AC: 6E02                       bgt     $225b0
0225AE: 602C                       bra     $225dc
0225B0: B06E 0050                  cmp.w   ($50,A6), D0
0225B4: 6526                       bcs     $225dc
0225B6: 322E 0060                  move.w  ($60,A6), D1
0225BA: 926E 0064                  sub.w   ($64,A6), D1
0225BE: 342E 0050                  move.w  ($50,A6), D2
0225C2: 0442 0010                  subi.w  #$10, D2
0225C6: B242                       cmp.w   D2, D1
0225C8: 6414                       bcc     $225de
0225CA: 906E 0050                  sub.w   ($50,A6), D0
0225CE: 0C40 0006                  cmpi.w  #$6, D0
0225D2: 6F04                       ble     $225d8
0225D4: 303C 0006                  move.w  #$6, D0
0225D8: D16E 0008                  add.w   D0, ($8,A6)
0225DC: 4E75                       rts
0225DE: 302E 0064                  move.w  ($64,A6), D0
0225E2: 0440 0010                  subi.w  #$10, D0
0225E6: 906E 0008                  sub.w   ($8,A6), D0
0225EA: 0C40 0006                  cmpi.w  #$6, D0
0225EE: 6F04                       ble     $225f4
0225F0: 303C 0006                  move.w  #$6, D0
0225F4: 4A40                       tst.w   D0
0225F6: 6A02                       bpl     $225fa
0225F8: 4240                       clr.w   D0
0225FA: D16E 0008                  add.w   D0, ($8,A6)
0225FE: 4E75                       rts
