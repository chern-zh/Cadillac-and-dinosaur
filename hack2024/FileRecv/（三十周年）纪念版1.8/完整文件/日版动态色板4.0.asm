...
_daobing		
		...
		bra    		_sxgy		
_bsdata
		*//dc.l		$98999696,$94937575,$15151515,$16131414,$5b5b5b5b,$123c3e3c,$02030100,$15751575		/匕首兵
...
_pzdata
		dc.l		$12131493
		*//dc.l		$01000202,$033c3e3e,$5b5b5b5b,$12991313,$14141414,$15167575,$93949601,$98167593		/胖子、打睡龙13C
...
_dlpang	
		...
		;move.b		($786,A5),D1
		;add.w		D1,D0
		;move.b		_dlpzdata(PC,D0),D1		;取下表中随机一色板
		move.b		#$75,D1
		move.b		D1,($Df,A6)				;色板号也写入敌人内存中
		bra    		_sxgy		
_dlpzdata
		*//dc.l		$01000202,$033c3e3e,$5b5b5b5b,$12991313,$14141414,$15167575,$93949601,$98167593		/打睡龙13C		
...
_hzdata
		...
		*//dc.l		$01000202,$18180303,$3e3e3e3e,$5b121313,$14141414,$15161616,$75939496,$98991993		/猴子		
...
_5B
		...
		bra    		_sxgy		
_5Bdata
		dc.l		$1d979797,$17172424,$29292929,$32737373,$74747474,$76777777,$40414242,$c01d4041	/马云
...
_5BB
		...
		bra    		_sxgy			
_5BBdata
		dc.l		$1d252525,$17172424,$32323232,$29362929,$73737373,$38747474,$76779777,$971d1717		*铁头龙、178
...
_tf
		...
		bra    		_sxgy		
_tfdata
		dc.l		$1d171d1d,$24242929,$32323232,$73747374,$76767676,$77777777,$1d241d29,$7376771d			/屠夫
...
_tyrog
		...
		bra    		_sxgy
_tyrogdata
		dc.l		$2a2b2a2a,$2d2d2e2e,$2f2f2f2f,$3b099e9e,$27272727,$72283131,$35710909,$963b2809	/16C
...
_sz
		...
		bra    		_sxgy		
_szdata
		dc.l		$1d171d17,$24242929,$32323232,$73747676,$77777777,$97253636,$38291d17,$1d172429			/狮子
...
_lrdata
		dc.l		$0f101111
		*//dc.l		$01000200,$033c3e3e,$5b5b5b5b,$12131414,$15161515,$95939494,$9698990f,$1011343c		/步枪兵		
...
_1B
		...
		bra    		_sxgy		
_lBdata
		dc.l		$1c1f9b9c,$4041429c			/大个子9f1b
...
_47b4
		...
		;move.b		($786,A5),D1
		;add.w		D1,D0
		move.b	_474bdata(PC,D0),D1		;取下表中随机一色板
		move.b	D1,($Df,A6)				;色板号也写入敌人内存中
		bra    	_sxgy		
_474bdata
		dc.l		$3a931121,$13161294		/4幻影
...
_47b7
		...
		;move.b		($786,A5),D1
		;add.w		D1,D0
		move.b	_477bdata(PC,D0),D1		;取下表中随机一色板
		move.b	D1,($Df,A6)				;色板号也写入敌人内存中
		bra    	_sxgy		
_477bdata
		dc.l		$A23a9314,$1622a294		/7幻影		
