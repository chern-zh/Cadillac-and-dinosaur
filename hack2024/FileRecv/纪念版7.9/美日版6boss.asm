...
================日版========================================
08E1BE: 303C 0021                  move.w  #$21, D0
08E1C2: 323C 0000                  move.w  #$0, D1
08E1C6: 343C 0000                  move.w  #$0, D2
08E1CA: 4EB9 0000 77DE             jsr     $77de.l
08E1D0: 1D7C 0002 0005             move.b  #$2, ($5,A6)
08E1D6: 4EB9 0000 19DE             jsr     $19de.l
08E1DC: 652A                       bcs     $8e208
08E1DE: 117C 0001 0000             move.b  #$1, ($0,A0)
08E1E4: 317C 012C 0020             move.w  #$12c, ($20,A0)
08E1EA: 317C 0000 0026             move.w  #$0, ($26,A0)
08E1F0: 117C 0000 0022             move.b  #$0, ($22,A0)
08E1F6: 316E 0008 0008             move.w  ($8,A6), ($8,A0)
08E1FC: 316E 000C 000C             move.w  ($c,A6), ($c,A0)
08E202: 316E 0010 0010             move.w  ($10,A6), ($10,A0)
08E208: 4EB9 0000 19DE             jsr     $19de.l
08E20E: 6530                       bcs     $8e240
08E210: 117C 0001 0000             move.b  #$1, ($0,A0)
08E216: 317C 012C 0020             move.w  #$12c, ($20,A0)
08E21C: 317C 0001 0026             move.w  #$1, ($26,A0)
08E222: 117C 0000 0022             move.b  #$0, ($22,A0)
08E228: 316E 0008 0008             move.w  ($8,A6), ($8,A0)
08E22E: 0468 0030 0008             subi.w  #$30, ($8,A0)
08E234: 316E 000C 000C             move.w  ($c,A6), ($c,A0)
08E23A: 316E 0010 0010             move.w  ($10,A6), ($10,A0)
08E240: 4EB9 0000 19DE             jsr     $19de.l
08E246: 6536                       bcs     $8e27e
08E248: 117C 0001 0000             move.b  #$1, ($0,A0)
08E24E: 317C 012C 0020             move.w  #$12c, ($20,A0)
08E254: 317C 0004 0026             move.w  #$4, ($26,A0)
08E25A: 117C 0000 0022             move.b  #$0, ($22,A0)
08E260: 316E 0008 0008             move.w  ($8,A6), ($8,A0)
08E266: 0668 0030 0008             addi.w  #$30, ($8,A0)
08E26C: 316E 000C 000C             move.w  ($c,A6), ($c,A0)
08E272: 316E 0010 0010             move.w  ($10,A6), ($10,A0)
08E278: 0468 0020 0010             subi.w  #$20, ($10,A0)
08E27E: 4EB9 0000 19DE             jsr     $19de.l
08E284: 6536                       bcs     $8e2bc
08E286: 117C 0001 0000             move.b  #$1, ($0,A0)
08E28C: 317C 012C 0020             move.w  #$12c, ($20,A0)
08E292: 317C 0004 0026             move.w  #$4, ($26,A0)
08E298: 117C 0000 0022             move.b  #$0, ($22,A0)
08E29E: 316E 0008 0008             move.w  ($8,A6), ($8,A0)
08E2A4: 0468 0010 0008             subi.w  #$10, ($8,A0)
08E2AA: 316E 000C 000C             move.w  ($c,A6), ($c,A0)
08E2B0: 316E 0010 0010             move.w  ($10,A6), ($10,A0)
08E2B6: 0668 0020 0010             addi.w  #$20, ($10,A0)
08E2BC: 7050                       moveq   #$50, D0
08E2BE: 4EB9 0008 AACC             jsr     $8aacc.l
08E2C4: 3D7C 0079 00A0             move.w  #$79, ($a0,A6)
08E2CA: 062E 0002 0005             addi.b  #$2, ($5,A6)
08E2D0: 4E75                       rts
08E2D2: 062E 0002 0005             addi.b  #$2, ($5,A6)
08E2D8: 3D7C 00DD 00A0             move.w  #$dd, ($a0,A6)
08E2DE: 7051                       moveq   #$51, D0
08E2E0: 4EB9 0008 AACC             jsr     $8aacc.l
08E2E6: 4E75                       rts
08E2E8: 062E 0002 0005             addi.b  #$2, ($5,A6)
08E2EE: 3D7C 0079 00A0             move.w  #$79, ($a0,A6)
08E2F4: 7052                       moveq   #$52, D0
08E2F6: 4EB9 0008 AACC             jsr     $8aacc.l
08E2FC: 4E75                       rts
08E2FE: 062E 0002 0005             addi.b  #$2, ($5,A6)
08E304: 3D7C 0079 00A0             move.w  #$79, ($a0,A6)
08E30A: 7053                       moveq   #$53, D0
08E30C: 4EB9 0008 AACC             jsr     $8aacc.l
08E312: 4E75                       rts
08E314: 6000 0012                  bra     $8e328
08E318: 536E 00A0                  subq.w  #1, ($a0,A6)
08E31C: 6600 0008                  bne     $8e326
08E320: 062E 0002 0005             addi.b  #$2, ($5,A6)
08E326: 4E75                       rts
08E328: 4EF9 0000 1ADA             jmp     $1ada.l
08E32E: 102E 0004                  move.b  ($4,A6), D0
08E332: 323B 0006                  move.w  ($6,PC,D0.w), D1
08E336: 4EFB 1002                  jmp     ($2,PC,D1.w)
08E33A: 0008                       dc.w    $0008; ILLEGAL
08E33C: 0014 0066                  ori.b   #$66, (A4)
08E340: 0066 1D7C                  ori.w   #$1d7c, -(A6)
08E344: 0002 0004                  ori.b   #$4, D2
08E348: 3D7C 0078 00A0             move.w  #$78, ($a0,A6)
08E34E: 536E 00A0                  subq.w  #1, ($a0,A6)
08E352: 6600 004A                  bne     $8e39e
08E356: 3D7C 0078 00A0             move.w  #$78, ($a0,A6)
08E35C: 4EB9 0000 119C             jsr     $119c.l
08E362: 0240 000F                  andi.w  #$f, D0
08E366: 0C40 0004                  cmpi.w  #$4, D0
08E36A: 6C00 0032                  bge     $8e39e
08E36E: 4EB9 0000 119C             jsr     $119c.l
08E374: 0240 0001                  andi.w  #$1, D0
08E378: 6600 0012                  bne     $8e38c
08E37C: 303C 0061                  move.w  #$61, D0
08E380: 323C 0000                  move.w  #$0, D1
08E384: 343C 0000                  move.w  #$0, D2
08E388: 6000 0014                  bra     $8e39e
08E38C: 303C 0078                  move.w  #$78, D0
08E390: 323C 0000                  move.w  #$0, D1
08E394: 343C 0000                  move.w  #$0, D2
08E398: 4EB9 0000 77DE             jsr     $77de.l
08E39E: 4E75                       rts
